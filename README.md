...
- [Extensive React Boilerplate](https://github.com/brocoders/extensive-react-boilerplate) - [demo](https://react-boilerplate-coral.vercel.app/en) `Boilerplate with Next.js, Auth (Sign in, Sign up, Reset password, Confirm email, Refresh Token), Material UI, React Hook Form, I18N, File uploads (support local and Amazon S3 drivers), Tests, CI.`
